...
import cn.mirrorming.blog.security.validate.code.ImageCode;
...
public class ValidateController {
    private static final String SESSION_KEY = "SESSION_KEY_IMAGE";
    ...
    public ImageCode generate(ServletWebRequest request) {
        ...
        return new ImageCode(image, sRand, 55);
    }
